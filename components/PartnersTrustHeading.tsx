...
export function PartnersTrustHeading({ title, subtitle, headingId }: Props) {
  return (
    <div className="mb-14 text-center md:mb-16">
      <h2
        id={headingId}
        className="font-headline text-2xl font-extrabold tracking-tight text-primary md:text-3xl lg:text-[2rem] motion-safe:animate-fade-up-soft"
      >
        {title}
      </h2>
      <div className="mx-auto mt-5 flex flex-col items-center gap-4">
        ...
        <p
          className="mx-auto max-w-2xl text-sm leading-relaxed text-on-surface-variant/95 md:text-[1.0625rem] motion-safe:animate-fade-up-soft motion-reduce:animate-none motion-reduce:opacity-100"
