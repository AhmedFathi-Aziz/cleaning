...
export const metadata: Metadata = buildArabicPageMetadata({
  title: "مناطق تغطية تنظيف بالرياض | أحياء العاصمة",
  description:
    "مناطق تغطية شركة تنظيف بالرياض — أحياء شمال ووسط وشرق العاصمة. اختر حيك واحجز تنظيف منازل أو مكافحة حشرات. تواصل عبر واتساب الآن.",
  canonical: "/areas",
  keywords: [
