...
export const metadata: Metadata = buildArabicPageMetadata({
  title: "حاسبة تقدير سعر التنظيف ومكافحة الحشرات وتعقيم الخزانات",
  description: `احسب تقديراً تقريبياً لتنظيف المنزل أو الشقة، ومكافحة الحشرات والرش، وتنظيف وتعقيم خزانات المياه في الرياض، ثم أرسل طلبك عبر واتساب إلى ${brandNameAr} — بدون التزام بالسعر النهائي حتى يتواصل الفريق.`,
  canonical: "/estimate",
  keywords: [
    "سعر تنظيف منزل",
    "تكلفة تنظيف شقة",
    ...
    "سعر تنظيف خزان مياه",
    "تعقيم خزانات المياه",
    "أدوات كشف التسرب الحديثة بجدة",
    "تقرير كشف تسربات معتمد",
    "تقرير فني شركة المياه",
    "أرخص أسعار شركات التنظيف",
  ],
});
    ...
    <main className="relative overflow-hidden bg-gradient-to-b from-slate-100 via-[#f4f6f9] to-slate-50 px-4 pb-28 pt-28 dark:from-slate-950 dark:via-[#0c1118] dark:to-slate-950 sm:px-6 md:px-8 md:pt-32">
      ...
      <div className="relative mx-auto max-w-4xl text-right">
        ...
        <h1 className="mt-3 font-headline text-3xl font-extrabold leading-[1.2] text-primary md:text-[2.35rem]">
          حاسبة تكلفة التنظيف والرش وتعقيم الخزانات التقديرية
        </h1>
      ...
      >
        ...
        <div className="mt-6 space-y-4 text-base font-medium leading-relaxed text-on-surface-variant">
          <p>
            ...
            {brandNameAr} عبر واتساب. لا يُعرض سعر نهائي على الشاشة؛ يُبنى العرض بعد مراجعة الفريق وربما
            المعاينة، بما يشمل الحالات التي تحتاج{" "}
            <strong className="font-bold text-primary">أدوات كشف التسرب الحديثة بجدة</strong> أو غيرها من
            المدن ضمن نطاق التغطية — حتى يُقارن العمل الفني بدقة دون تخمين عشوائي.
          </p>
          <p>
