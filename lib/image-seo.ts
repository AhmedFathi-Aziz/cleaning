...
const SERVICE_HERO_ALT_BASE: Record<string, string> = {
  ...
  "cockroach-control-riyadh":
    "مكافحة الصراصير بالرياض — شعار السعودية للتنظيف على خلفية بيضاء لخدمة رش ومعالجة الصراصير",
  "termite-control-riyadh":
    "مكافحة النمل الأبيض بالرياض — شعار السعودية للتنظيف على خلفية بيضاء لخدمة فحص ومعالجة الأرضة",
